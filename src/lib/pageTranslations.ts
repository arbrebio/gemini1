...
const about = {
  en: {
    ...
    cards: [
      { icon: "greenhouse", title: "Greenhouse Construction", desc: "High-tech sawtooth and tunnel greenhouses engineered for African tropical conditions, with full climate control and drip irrigation integration." },
      { icon: "water", title: "Precision Irrigation", desc: "Smart drip and sprinkler systems that save up to 60% water while dramatically increasing crop yields. Designed and installed for African farms." },
      { icon: "plant", title: "Growing Solutions", desc: "Premium coco peat substrates and organic growing mediums for hydroponic and soil-based cultivation of high-yield vegetables and fruits." }
    ],
  ...
  fr: {
    ...
    cards: [
      { icon: "greenhouse", title: "Construction de Serres", desc: "Serres sawtooth et tunnel haute technologie conçues pour les conditions tropicales africaines, avec contrôle climatique complet et irrigation goutte-à-goutte intégrée." },
      { icon: "water", title: "Irrigation de Précision", desc: "Systèmes goutte-à-goutte et d'aspersion intelligents qui économisent jusqu'à 60% d'eau tout en augmentant considérablement les rendements agricoles." },
      { icon: "plant", title: "Solutions de Culture", desc: "Substrats premium à base de coco peat et milieux de culture organiques pour la culture hydroponique et en sol de légumes et fruits à haut rendement." }
    ],
  ...
  es: {
    ...
    cards: [
      { icon: "greenhouse", title: "Construcción de Invernaderos", desc: "Invernaderos de alta tecnología tipo sawtooth y túnel diseñados para condiciones tropicales africanas, con control climático completo e irrigación por goteo integrada." },
      { icon: "water", title: "Riego de Precisión", desc: "Sistemas de goteo y aspersión inteligentes que ahorran hasta un 60% de agua y aumentan drásticamente los rendimientos de los cultivos." },
      { icon: "plant", title: "Soluciones de Cultivo", desc: "Sustratos premium de fibra de coco y medios de cultivo orgánicos para el cultivo hidropónico y en suelo de hortalizas y frutas de alto rendimiento." }
    ],
  ...
  af: {
    ...
    cards: [
      { icon: "greenhouse", title: "Kwekhuis Konstruksie", desc: "Hoë-tegnologie sawtooth en tonnel kweekhuise ontwerp vir Afrika se tropiese toestande, met volledige klimaatbeheer en drup besproeiing integrasie." },
      { icon: "water", title: "Presisie Besproeiing", desc: "Slim drup- en sproeistelsels wat tot 60% water bespaar terwyl gewasopbrengste dramaties verhoog word. Ontwerp en geïnstalleer vir Afrika se plase." },
      { icon: "plant", title: "Groei Oplossings", desc: "Premium koko-turfmos substrate en organiese groeimedia vir hidroponies en grondgebaseerde verbouing van hoë-opbrengs groente en vrugte." }
    ],
...
const timeline = {
  en: [
    { year: 2020, event: "Arbre Bio Founded", description: "Founded in Abidjan, Côte d'Ivoire by Sydney Abouna with a bold vision to transform African agriculture through precision farming", icon: "plant" },
    { year: 2021, event: "First Major Greenhouse Project", description: "Delivered our first large-scale greenhouse installation, setting the standard for modern agriculture in Côte d'Ivoire", icon: "greenhouse" },
    { year: 2022, event: "Strategic Partnerships", description: "Key partnerships signed with AZUD, Hortalan, World Bank, GIZ and the Ivorian Ministry of Agriculture", icon: "handshake" },
    { year: 2023, event: "Pan-African Expansion", description: "Expanded to 5 African countries completing 500+ projects across Côte d'Ivoire, Ghana, Burkina Faso, Zimbabwe and Kenya", icon: "rocket" },
    { year: 2024, event: "Digital Farming Launch", description: "Launched smart farming solutions with IoT monitoring and AI-powered analytics for modern farm management", icon: "laptop" },
    { year: 2025, event: "Hortalan Joint Venture", description: "Establishing a landmark joint venture with Hortalan to open their first branch in Côte d'Ivoire", icon: "trophy" }
  ],
  fr: [
    { year: 2020, event: "Fondation d'Arbre Bio", description: "Fondée à Abidjan, Côte d'Ivoire par Sydney Abouna avec une vision audacieuse de transformer l'agriculture africaine par l'agriculture de précision", icon: "plant" },
    { year: 2021, event: "Premier Grand Projet de Serre", description: "Réalisation de notre première installation de serre à grande échelle, établissant la norme pour l'agriculture moderne en Côte d'Ivoire", icon: "greenhouse" },
    { year: 2022, event: "Partenariats Stratégiques", description: "Partenariats clés signés avec AZUD, Hortalan, la Banque Mondiale, la GIZ et le Ministère ivoirien de l'Agriculture", icon: "handshake" },
    { year: 2023, event: "Expansion Pan-Africaine", description: "Expansion dans 5 pays africains avec 500+ projets réalisés en Côte d'Ivoire, Ghana, Burkina Faso, Zimbabwe et Kenya", icon: "rocket" },
    { year: 2024, event: "Lancement Agriculture Digitale", description: "Lancement de solutions d'agriculture intelligente avec surveillance IoT et analytique pilotée par IA", icon: "laptop" },
    { year: 2025, event: "Joint-Venture Hortalan", description: "Établissement d'une joint-venture avec Hortalan pour ouvrir leur première agence en Côte d'Ivoire", icon: "trophy" }
  ],
  es: [
    { year: 2020, event: "Fundación de Arbre Bio", description: "Fundada en Abiyán, Costa de Marfil por Sydney Abouna con una audaz visión de transformar la agricultura africana a través de la agricultura de precisión", icon: "plant" },
    { year: 2021, event: "Primer Gran Proyecto de Invernadero", description: "Entregamos nuestra primera instalación de invernadero a gran escala, estableciendo el estándar para la agricultura moderna en Costa de Marfil", icon: "greenhouse" },
    { year: 2022, event: "Alianzas Estratégicas", description: "Alianzas clave firmadas con AZUD, Hortalan, el Banco Mundial, GIZ y el Ministerio de Agricultura de Costa de Marfil", icon: "handshake" },
    { year: 2023, event: "Expansión Panafricana", description: "Expansión a 5 países africanos completando 500+ proyectos en Costa de Marfil, Ghana, Burkina Faso, Zimbabue y Kenia", icon: "rocket" },
    { year: 2024, event: "Lanzamiento de Agricultura Digital", description: "Lanzamiento de soluciones de agricultura inteligente con monitoreo IoT y análisis basados en IA", icon: "laptop" },
    { year: 2025, event: "Empresa Conjunta con Hortalan", description: "Establecimiento de una empresa conjunta con Hortalan para abrir su primera sucursal en Costa de Marfil", icon: "trophy" }
  ],
  af: [
    { year: 2020, event: "Arbre Bio Gestig", description: "Gestig in Abidjan, Ivoorkus deur Sydney Abouna met 'n gedurfdede visie om Afrika se landbou deur presisieboerdery te transformeer", icon: "plant" },
    { year: 2021, event: "Eerste Groot Kwekhuis Projek", description: "Ons eerste grootskaalse kwekhuisinstallasie gelewer, die standaard vir moderne landbou in Ivoorkus gestel", icon: "greenhouse" },
    { year: 2022, event: "Strategiese Vennootskappe", description: "Sleutelvennootskappe onderteken met AZUD, Hortalan, die Wêreldbank, GIZ en die Ivoorkus Ministerie van Landbou", icon: "handshake" },
    { year: 2023, event: "Pan-Afrika Uitbreiding", description: "Uitgebrei na 5 Afrika-lande met 500+ voltooide projekte in Ivoorkus, Ghana, Burkina Faso, Zimbabwe en Kenia", icon: "rocket" },
    { year: 2024, event: "Digitale Boerdery Bekendstelling", description: "Slim boerdery oplossings bekendgestel met IoT monitering en KI-gedrewe analitiek vir moderne plaasbestuur", icon: "laptop" },
    { year: 2025, event: "Hortalan Gesamentlike Onderneming", description: "Stigting van 'n toonaangewende gesamentlike onderneming met Hortalan om hul eerste tak in Ivoorkus te open", icon: "trophy" }
  ]
};
