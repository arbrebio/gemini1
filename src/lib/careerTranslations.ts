...
const en: CareerTranslations = {
  ...
  maxFileSize: 'Maximum total upload size: 4 MB',
...
const fr: CareerTranslations = {
  ...
  maxFileSize: 'Taille totale maximale des fichiers : 4 Mo',
...
const es: CareerTranslations = {
  ...
  maxFileSize: 'Tamaño total máximo de los archivos: 4 MB',
...
const af: CareerTranslations = {
  ...
  maxFileSize: 'Maksimum totale oplaaigrootte: 4 MB',
