  ...
  es: {
    ...
    blog: {
      ...
      post: {
        ...
        needExpertAdvice: '¿Necesita asesoramiento de expertos?',
        expertAdviceDesc: 'Nuestro equipo está aquí para ayudarle a implementar estas soluciones en su granja.',
  ...
  af: {
    ...
    blog: {
      ...
      post: {
        ...
        needExpertAdvice: 'Benodig Deskundige Advies?',
        expertAdviceDesc: 'Ons span is hier om jou te help om hierdie oplossings op jou plaas te implementeer.',
        contactUs: 'Kontak Ons'
      }
    },
    privacy: {
