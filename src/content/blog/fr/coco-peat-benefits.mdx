...
Arbre Bio Africa distribue [de la fibre de coco et des substrats de culture de qualité professionnelle](/fr/substrates/), sélectionnés et testés pour répondre aux standards les plus exigeants. Elle s'associe particulièrement bien à l'[irrigation de précision](/fr/irrigation/) et à la [culture sous serre](/fr/greenhouses/), où la maîtrise de l'apport en eau exploite pleinement les propriétés de rétention du substrat. Nos équipes peuvent vous conseiller sur les quantités, les mélanges et les modes d'application adaptés à votre situation. Contactez-nous pour en savoir plus sur nos produits et nos tarifs.
